      ...
      <div className="bg-white rounded-lg shadow-sm border p-6">
        ...
        <div className="md:hidden space-y-4">
          {filteredSites.length === 0 ? (
            ...
            filteredSites.map(site => (
              <div key={site.id} className="bg-white border border-gray-200 rounded-lg p-4">
                ...
                <div key={tenant.id} className="bg-white border border-gray-200 rounded-lg p-4">
                  <div className="flex justify-between items-start mb-3">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">{site?.name || 'N/A'} - {tenant.doorNumber}</p>
                    </div>
                    <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${
                      tenant.status === 'active' 
                        ? 'bg-green-100 text-green-800' 
                  ...
                  <div className="space-y-2 mb-4">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-sm font-medium text-gray-900">₱{tenant.baseRent.toLocaleString()}</span>
                    </div>
                  </div>
                  <div className="flex space-x-3">
                    <button 
